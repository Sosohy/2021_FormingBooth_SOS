...
namespace UnityWebGLSpeechSynthesis
{
    public class TTSManager : MonoBehaviour
    {
        ...
        /// </summary>
        private static ISpeechSynthesisPlugin _mSpeechSynthesisPlugin = null;
        ...
        /// </summary>
        private static SpeechSynthesisUtterance _mSpeechSynthesisUtterance = null;
        ...
        /// </summary>
        private static string _mTextToSpeak = string.Empty;

        /// <summary>
        /// Save a reference to the script to be accessed outside the class
        /// </summary>
        private static TTSManager _sInstance = null;
        ...
        public static void Speak(string text)//string textToSpeak)
        {
            if (null == _mSpeechSynthesisUtterance)
            {
                Debug.LogError("Utterance is not set!");
        ...
        {
            if (_mVoicesSet && _mUtteranceSet && null != _mSpeechSynthesisUtterance)
            {
                // set a random voice
                if (null != _mVoiceResult && null != _mVoiceResult.voices && _mVoiceResult.voices.Length > 0)
                {
